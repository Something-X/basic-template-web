...
<body class="bg-white dark:bg-white">
  <aside id="sidebar" class="fixed left-0 top-0 z-10 h-screen w-16 border-r border-gray-300/40 bg-white dark:bg-gray-900 dark:border-gray-700 hover:w-56 hover:shadow-2xl transition-all duration-300 overflow-hidden">
      ...
      <div>
        ...
        <div class="h-16 border-b border-gray-300/40 dark:border-gray-700 flex items-center">
          <a href="" class="flex items-center space-x-3">
            ...
            <p class="text-lg font-semibold text-gray-800 dark:text-gray-200 whitespace-nowrap transition-opacity duration-300 opacity-0 px-2">ShoeCycle</p>
          </a>
        </div>
        <div class="mt-6">
          <ul class="px-0.5 -ml-px font-medium tracking-wide transition-all duration-300">
            <li class="w-max space-y-4 group-hover:w-full">
              <a href="" class="relative flex items-center py-3 px-1 rounded-full hover:bg-white transition-all duration-300">
                <div class="w-max flex px-4 gap-4">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="23" viewBox="0 0 512.001 512.001"><g><path d="M490.134 185.472 338.966 34.304c-45.855-45.737-120.076-45.737-165.931 0L21.867 185.472A74.18 74.18 0 0 0 0 238.272v221.397C.047 488.568 23.475 511.976 52.374 512h407.253c28.899-.023 52.326-23.432 52.373-52.331V238.272a74.175 74.175 0 0 0-21.866-52.8zM448 448H341.334v-67.883c0-44.984-36.467-81.451-81.451-81.451h-7.765c-44.984 0-81.451 36.467-81.451 81.451V448H64V238.272a10.773 10.773 0 0 1 3.115-7.552L218.283 79.552c20.825-20.831 54.594-20.835 75.425-.01l.01.01L444.886 230.72a10.777 10.777 0 0 1 3.115 7.552V448z" fill="#fbfbfb"></path></g></svg>
                  <span class="text-white text-center px-4">Beranda</span>
                </div>
              </a>
            </li>
            <li class="w-max space-y-2 group-hover:w-full pt-2">
              <span class="relative flex items-center py-3 px-1 rounded-full hover:bg-white transition-all duration-300" onclick="toggleSubmenu()">
                <div class="w-max flex items-center px-4 gap-1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="23" viewBox="0 0 24 24" xml:space="preserve"><g><path d="M0 3.5V10h10V0H3.5C1.57 0 0 1.57 0 3.5ZM7 7H3V3.5a.5.5 0 0 1 .5-.5H7v4Zm15-3.5C22 1.57 20.43 0 18.5 0H12v10h10V3.5ZM19 7h-4V3h3.5a.5.5 0 0 1 .5.5V7ZM0 18.5C0 20.43 1.57 22 3.5 22H10V12H0v6.5ZM3 15h4v4H3.5a.5.5 0 0 1-.5-.5V15Zm20.907 6.786-2.491-2.491A4.931 4.931 0 0 0 22 17c0-2.757-2.243-5-5-5s-5 2.243-5 5 2.243 5 5 5c.831 0 1.604-.223 2.295-.584l2.491 2.491 2.121-2.121ZM17 19c-1.103 0-2-.897-2-2s.897-2 2-2 2 .897 2 2-.897 2-2 2Z" fill="#ffffff"></path></g></svg>
                  <span class="text-white text-center px-7 pr-2">Kategori</span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" class="mt-2 text-sm rotate-0 transition-all duration-300" id="arrow"><g><path d="M1.51 6.079a1.492 1.492 0 0 1 1.06.44l7.673 7.672a2.5 2.5 0 0 0 3.536 0l7.661-7.662a1.5 1.5 0 1 1 2.121 2.121L15.9 16.312a5.505 5.505 0 0 1-7.778 0L.449 8.64A1.5 1.5 0 0 1 1.51 6.079Z" fill="#ffffff"></path></g></svg>
                </div>
              </span>
              <div class="text-left text-sm font-thin mt-2 w-4/5 mx-auto text-gray-200 transition-max-height duration-300 ease-in-out overflow-hidden max-h-0" id="submenu">
                <a href="">
                  <h1 class="cursor-pointer p-2 bg-gray-700 rounded-t-lg  hover:bg-white hover:text-black font-normal">Sepatu sekolah</h1>
                </a>  
                <a href="">
                  <h1 class="cursor-pointer p-2 bg-gray-700 rounded-md-  hover:bg-white hover:text-black font-normal">Sepatu olahraga</h1>
                </a>  
                <a href="">
                  <h1 class="cursor-pointer p-2 bg-gray-700 rounded-b-lg hover:bg-white hover:text-black font-normal">Sepatu kasual</h1>
                </a>  
              </div>
            </li>
            <li class="w-max space-y-4 group-hover:w-full pt-2">
              <a href="" class="relative flex items-center py-3 px-1 rounded-full hover:bg-white transition-all duration-300">
                <div class="w-max flex px-4 gap-4">
                  ...
                  <span class="text-white text-center px-3">Keranjang</span>
                </div>
              </a>
              <div id="garis" class="border-gray-300 border-t transition-opacity opacity-0 duration-300 pb-2"></div>
            </li>   
           <li class="w-max space-y-4 group-hover:w-full pt-2">
              <a href="" class="relative flex items-center py-3 px-1 rounded-full hover:bg-white transition-all duration-300">
                <div class="w-max flex px-4 gap-4">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="23" x="0" y="0" viewBox="0 0 24 24" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="M12 12a6 6 0 1 0-6-6 6.006 6.006 0 0 0 6 6Zm0-10a4 4 0 1 1-4 4 4 4 0 0 1 4-4ZM12 14a9.01 9.01 0 0 0-9 9 1 1 0 0 0 2 0 7 7 0 0 1 14 0 1 1 0 0 0 2 0 9.01 9.01 0 0 0-9-9Z" fill="#ffffff" opacity="1" data-original="#000000" class=""></path></g></svg>
                  <span class="text-white text-center px-4 ">Profil</span>
                </div>
              </a>
              <div id="garis" class=" border-gray-300 border-t w-[185px] transition-opacity opacity-0 duration-300 pb-3"></div>
            </li>
           <li class="absolute top-[600px] w-max space-y-4 group-hover:w-full">
              <a href="" class="flex items-center py-3 px-1 rounded-full hover:bg-white transition-all duration-300">
                <div class=" w-max flex px-4 gap-4">
                  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="23" x="0" y="0" viewBox="0 0 24 24" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="M22.829 9.172 18.95 5.293a1 1 0 0 0-1.414 1.414l3.879 3.879a2.057 2.057 0 0 1 .3.39c-.015 0-.027-.008-.042-.008L5.989 11a1 1 0 0 0 0 2l15.678-.032c.028 0 .051-.014.078-.016a2 2 0 0 1-.334.462l-3.879 3.879a1 1 0 1 0 1.414 1.414l3.879-3.879a4 4 0 0 0 0-5.656Z" fill="#ffffff" opacity="1" data-original="#000000" class=""></path><path d="M7 22H5a3 3 0 0 1-3-3V5a3 3 0 0 1 3-3h2a1 1 0 0 0 0-2H5a5.006 5.006 0 0 0-5 5v14a5.006 5.006 0 0 0 5 5h2a1 1 0 0 0 0-2Z" fill="#ffffff" opacity="1" data-original="#000000" class=""></path></g></svg>
                  <span class="text-white text-center px-4 ">Keluar</span>
                </div>
              </a>
           </li>            
          </ul>
  ...
  <style>
    ...
    /* Beranda hover style */
    a:hover svg path, a:hover span {
      fill: black;
      color: black;
    }
    /* Category hover */
    span:hover span, span:hover svg path{
      color: black;
      fill: black;
    }
    /* Trolli hover */
  ...
  <script type="text/javascript">
    function toggleSubmenu() {
      ...
      // Toggle submenu height and rotate arrow 
...
<div class="carousel relative ml-[5rem] h-[800px] overflow-hidden">
  <div class="bg-gradient-to-r from-slate-300 to-slate-800 bg-opacity-30 backdrop-blur-md rounded-lg h-[450px] mt-2 w-[1167px] flex justify-center items-center">
    <h1 class="-mt-[390px] -ml-[1030px] bg-white rounded-br-lg rounded-tl-lg m-6 p-2 text-lg font-semibold text-gray-800">ShoeCycle</h1>
...
<div class="flex flex-wrap justify-center gap-2 ml-16 mt-8">
  <!-- Card 1 -->
...
<h1 class="text-center ml-16 font-semibold">PRODUK LAINNYA</h1>
<!--baris1 -->
<div class="animate-target flex gap-12 ml-16 justify-center mt-16 opacity-0 translate-y-10 transition-all duration-700">
...
<!-- baris2 -->
<div class="animate-target flex gap-12 ml-16 justify-center mt-7 opacity-0 translate-y-10 transition-all duration-700">
    <div class="w-60 h-auto bg-neutral-800 rounded-3xl text-neutral-300 p-4 flex flex-col items-start justify-center gap-3 hover:bg-gray-900 hover:shadow-2xl hover:shadow-sky-400 transition-shadow">
        <div class="w-52 h-40 bg-white rounded-2xl"><img src="images/s2.png" alt="" class="-mt-8"></div>
        <div>
            <p class="font-extrabold">Sepatu NIKE</p>
...
<div class="bg-gray-950 w-auto h-72 mt-20">
  <div class="flex ml-16 items-center pt-3">
     <img src="images/logos.png" alt="Logo" class="h-12 w-auto px-1.5">
     <p class="text-lg font-semibold text-white">ShoeCycle</p>
  </div>
  <div>
    <h1 class="ml-20 mt-4 text-white font-bold">Layanan pengaduan konsumen ShoeCycle</h1>
    <h6 class="ml-20 mt-2 text-white text-sm"><a href="">E-mail   : shoecycle@gmail.com</a></h6>
    <p class="ml-20 text-white text-sm"><a href="">WhatsApp : +62 857 0463 7649</a></p>
    <p class="ml-20 mt-9 text-white font-bold">Temukan kami</p>
    <div class="flex ml-20 mt-2 gap-3">
     <!-- ig   -->
  ...
  <div>
  <h1 class="ml-[530px] -mt-[165px] text-white font-bold">Lokasi toko kami</h1>
  <h1 class="ml-[530px] mt-2 text-white font-sm">Jl.Jendral Ahmad Yani No.17 Kedunglengkong,<br> Jabaran, Pohkecik, Kec. Dlanggu, Kab. Mojokerto,<br> Jawa Timur</h1>
